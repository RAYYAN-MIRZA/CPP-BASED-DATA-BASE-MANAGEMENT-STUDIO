...
MultiStepForm::~MultiStepForm()
{
    ...
    delete this->layout; // sb ek hi line me
    ...
    // qDebug()<<"kidefer tuka";
    // delete this->label1;//s

    // qDebug()<<"kidefer tuka";
    // delete this->label2;//use kar donu ko be

    // qDebug()<<"kidefer tuka5";
    // delete this->label3;
    ...
    // }
    // else{
    //     qDebug()<<"pehle se stacknullptr tha ";
    // }
    // qDebug()<<"kidefer tuka7";

    // delete this->tableData;
    // qDebug()<<"kidefer tuka8";
    // delete this->tab;
    qDebug() << "Form ja raha finally";
}
