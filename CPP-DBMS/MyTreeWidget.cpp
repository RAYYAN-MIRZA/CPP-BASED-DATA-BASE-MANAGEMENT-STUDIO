...
void MyTreeWidget::starttree()
{
    ...
    this->tree->setSizePolicy(QSizePolicy::Maximum, QSizePolicy::Expanding);
    this->tree->setEditTriggers(QAbstractItemView::NoEditTriggers);  // Disable edit triggers on double-click
