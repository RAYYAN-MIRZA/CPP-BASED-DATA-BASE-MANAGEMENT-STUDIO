...
void MyTableWidget::handleTimeChanged(const QTime& time){
    ...
    if (timeEdit) {
        qDebug() << "Time changed at "<<" Time:" << time.toString("hh:mm:ss");
        ...
        for (int j = 0; j < this->tableWidget->columnCount(); j++)
        {
            ...
            /* if ((*this->tableData)[1][j][0] == 's') {
               ...
               // item->setData(Qt::EditRole, date);
                ...
                QComboBox* trueFalseComboBox = qobject_cast<QComboBox*>(this->tableWidget->item(i, j));
                ...
                QTimeEdit* timeEdit = qobject_cast<QTimeEdit*>(this->tableWidget->item(i, j));
                if (timeEdit) {
                    ...
                    out<<formattedTime;
                    // If you want to save it in your tableData vector, you can do something like:
                    // (*this->tableData)[k][j] = formattedTime;
                }
                else {
...
*/
            ...
            // if (item) {
            //     qDebug() << "Row:" << i << "Column:" << j << "Value:" << item->text();
            //     out << item->text();
            // } else {
            //     // Check if it's a checkbox
            //     // QCheckBox* checkBox = qobject_cast<QCheckBox*>(tableWidget->cellWidget(i, j));
            //     // if (checkBox) {
            //     //     qDebug() << "i:" << i << "jumn:" << j << "Value:" << (checkBox->isChecked() ? "true" : "false");
            //     //     out << (checkBox->isChecked() ? "true" : "false");
            //     // }
            //     QComboBox* comboBox = qobject_cast<QComboBox*>(tableWidget->cellWidget(i, j));
            //     if (comboBox) {
            //         qDebug() << "i:" << i << "jumn:" << j << "Value:" << comboBox->currentText();
            //         qDebug()<<"current =============" << comboBox->currentText();

            //         out << comboBox->currentText();
            //     }
            //         else {
            //         // Check if it's a QTimeEdit widget
            //         QTimeEdit* timeEdit = qobject_cast<QTimeEdit*>(tableWidget->cellWidget(i, j));
            //         if (timeEdit) {
            //             qDebug() << "i:" << i << "jumn:" << j << "Value:" << timeEdit->time().toString("hh:mm:ss");
            //             out << timeEdit->time().toString("hh:mm:ss");
            //         }
            //     }
            // }
